...
public class WorldRenderer {
	 ...
	 *  @details Method which initializes an instance of WorldRenderer
	...
	/** @brief Set size of viewport
	 *  @details Adjust size of world
...
//	}
	...
	/** @brief Get camera
	 * @return camera OrthographicCamera object
	 */
	...
	/** @brief Disposing render of world
	 */
	public void dispose() {
		stage.dispose();
		renderer.dispose();
